 ...
 *  -
 *
 * $Id: apprx-diam.c,v 1.1 2002/07/24 12:43:44 greg Exp $
 *
 * Copyright INRIA
 *
 * AUTHOR:
...
void _VerboseInApprxDiam()
{
  _verbose_ = 1;
}
void _NoVerboseInApprxDiam()
{
  _verbose_ = 0;
}
...
double _EstimeDiameterInOneList( typeSegment *theDiam,
				 double **theList,
				 const int first,
				 const int last,
				 const int dim,
